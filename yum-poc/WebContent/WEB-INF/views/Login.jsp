		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Recuperação de
						senha</h5>
				...
				<div class="modal-body">
					<form>
						<div class="form-group">
							<label for="recipient-name" class="col-form-label">Seu
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-8 col-sm-12 col-xs-6 caixafundo">
						<img src="resources/img/Logo2.png" class="rounded mx-auto d-block"
							alt="Responsive image" id="caixa-img"> <br>
						<div class="container">
							<div class="form-group">
						...
						<div class="col-lg-12">
							<button type="submit"
								class="btn btn-outline-primary btn-lg btn-block" id="butao">Entrar</button>
						</div>
						<div class="caixa_senha" data-toggle="modal"
							data-target="#exampleModal" data-whatever="@fat">Esqueci a
							senha</div>
