				...
				<div class="carousel-inner" role="listbox">
					...
					<div class="item active">
						...
						<div class="carousel-caption">
							...
							<h1>IoT</h1>
							<p>Raspberry é usado como inovação principal da nossa
								solução.</p>
						</div>
					</div>
				...
				<div class="row">
					...
					<div
						...
						<p>
							...
							de ser muito atual e open source, oferemos nosso servicço com o
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5 col-md-5 col-sm-4 col-xs-12 footer">
					<ul class="frase-footer">feito com ❤ por YumPoc®
					</ul>
				</div>
